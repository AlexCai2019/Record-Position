...
#沒有物品
give @s book[item_name='["記錄位置 ", {"text": "(", "color": "gray", "extra": [{"keybind": "key.use"}, ")"]}]', food={can_always_eat: true, eat_seconds: 86400.0F, nutrition: 1, saturation: 1.0F}, enchantment_glint_override=true, custom_data={record: true}]
give @s compass[item_name='["傳送到記錄點 ", {"text": "(", "color": "gray", "extra": [{"keybind": "key.use"}, ")"]}]', food={can_always_eat: true, eat_seconds: 86400.0F, nutrition: 1, saturation: 1.0F}, lodestone_tracker={}, custom_data={record: true}]
