...
tellraw @s [{"text": "<", "clickEvent": {"action": "run_command", "value": "/execute as @a run function record:setting"}, "hoverEvent": {"action": "show_text", "contents": "開啟設定"}}, {"text": "記錄位置", "color": "blue"}, "> 使用 ", {"text": "/function record:setting", "color": "gold", "underlined": true}, " 開啟設定。"]
tellraw @s ["<", {"text": "記錄位置", "color": "blue"}, "> 使用 ", {"text": "/function record:uninstall", "color": "red", "underlined": true, "clickEvent": {"action": "run_command", "value": "/function record:uninstall"}, "hoverEvent": {"action": "show_text", "contents": "執行 /function record:uninstall"}}, " 解除安裝。"]
