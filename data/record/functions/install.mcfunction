...
tellraw @s ["<", {"text": "記錄位置", "color": "blue"}, "> 使用 ", {"text": "/function record:setting", "color": "gold", "clickEvent": {"action": "run_command", "value": "/execute as @a run function record:setting"}, "hoverEvent": {"action": "show_text", "contents": "開啟設定"}}, " 開啟設定。"]
tellraw @s ["<", {"text": "記錄位置", "color": "blue"}, "> 使用 ", {"text": "/function record:uninstall", "color": "red", "clickEvent": {"action": "run_command", "value": "/function record:uninstall"}, "hoverEvent": {"action": "show_text", "contents": ["執行", {"text": "解除安裝", "color": "red"}]}}, " 解除安裝。"]
