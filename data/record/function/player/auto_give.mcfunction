...
give @s compass[item_name='["傳送到記錄點 ", {"text": "(", "color": "gray", "extra": [{"keybind": "key.use"}, ")"]}]', consumable={consume_seconds: 86400.0F}, lodestone_tracker={}, !enchantments, custom_data={record: true}]
